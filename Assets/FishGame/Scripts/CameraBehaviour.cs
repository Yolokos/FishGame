...
namespace Fish
{
	...
	public class CameraBehaviour : MonoBehaviour
	{
        ...
        [Tooltip("The width we want the camera to be above the target")]
        [SerializeField]
        ...
        [Tooltip("The Smooth time lag for the height of the camera.")]
        [SerializeField]
        private float widthSmoothLag = 0.3f;
        ...
        private float targetWidth = 100000.0f;
		...
		void Apply()
	    {
            ...
            targetWidth = targetCenter.x + width;

            // Damp the height
            float currentHeight = cameraTransform.position.y;
	        currentHeight = Mathf.SmoothDamp( currentHeight, targetHeight, ref heightVelocity, heightSmoothLag );

            float currentWidth = cameraTransform.position.x;
            currentWidth = Mathf.SmoothDamp(currentWidth, targetWidth, ref widthVelocity, widthSmoothLag);
	        ...
	        cameraTransform.position = new Vector3(currentWidth, currentHeight, cameraTransform.position.z );
